...
{
  "$end", "error", "$undefined", "STRING", "FATOR", "VAR", "IGUAL", "EOL",
  "ASPA", "ACOL", "FCOL", "SOMA", "PRODUTO", "DIVISAO", "$accept",
...
{
       2,    11,    12,     3,     6,     7,     8,     9,     0,     4,
      13,    10,    14
};

static const yytype_int8 yycheck[] =
{
       0,    12,    13,     3,     6,     3,     7,     3,    -1,     9,
       4,    10,     4
};
